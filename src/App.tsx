...
function App() {
  ...
  return (
    ...
    <ElementContainer ElementsGroup={<OtherMetalsGroup/>} GroupName="Outros Metais"/>
    ...
    <ElementContainer ElementsGroup={<HalogenGroup/>} GroupName="Halogêneos"/>
    <ElementContainer ElementsGroup={<LathanidesGroup/>} GroupName="Latanídeos"/>
    <ElementContainer ElementsGroup={<ActinidesGroup/>} GroupName="Actinídeos"/>
